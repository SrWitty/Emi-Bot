...
module.exports = {
    ...
    .setName('bot')
    .setDescription(`Shows Emi Bot's information.`)
    .addSubcommand(command => command.setName('stats').setDescription('Shows some basic statistics about Emi Bot.'))
    .addSubcommand(command => command.setName('specs').setDescription('Shows the specifications that Emi Bot uses.'))
    .addSubcommand(command => command.setName('ping').setDescription(`Displays the bot's ping... Pong.. PANG!!`))
    .addSubcommand(command => command.setName('online').setDescription(`Shows the online status of Emi Bot, a great way to see if our bot works!`)),
    async execute(interaction, client) {
        ...
        .addComponents(
            ...
            .setURL("https://discord.gg/vz37E7XJu7"),
 
            new ButtonBuilder()
            .setLabel('Bot Invite')
            .setStyle(ButtonStyle.Link)
            .setURL("https://discord.com/api/oauth2/authorize?client_id=1123512997277597736&permissions=8&scope=bot%20applications.commands")
        )
        ...
        .setFooter({ text: `🤖 Emi Bot's statistics`})
        .setTimestamp()
        ...
        .setColor("DarkBlue")
        .setTitle('Connection between Emi Bot \nand your client')
        ...
        .setDescription('> Emi Bot is fuctioning correctly.')
